...
namespace ariel
{
  class Game {
    ...
    public:
      ...
      // The number of turns was a draw
      int amountOfDrawsTurn();
      ...
      int calculationPercentages(int,int);

      Game(const Game&) = default; // copy constructor
Game& operator=(const Game&) = default; // copy assignment operator
Game(Game&&) noexcept = default; // move constructor
Game& operator=(Game&&) noexcept = default; // move assignment operator
